    ...
    builder: (context) => Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Custom_Text(text: 'Update profile picture', fontWeight: FontWeight.w500, fontSize: 16),
                ...
                child: Align(
                  ...
                  child: Row(
                    children: const [
                      ...
                      SizedBox(width: 10.0),
                      Custom_Text(text: 'Select from gallery', fontSize: 17),
                    ],
                  ))
              ),
            ),
                ...
                child: Align(
                  ...
                  child: Row(
                    children: const [
                      ...
                      SizedBox(width: 10.0),
                      Custom_Text(text: 'Take picture', fontSize: 17),
                    ],
                  ))
              ),
            ),
