              ...
              ? Row(
                  children: [
                    ...
                    : CircleAvatar(
                      ...
                      child: Custom_Text(text: state.user!.users.substring(0,2).toUpperCase(), fontWeight: FontWeight.bold, color: Colors.white,),
                    ),
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: BlocBuilder<ProductBloc, ProductState>(
                          builder: (context, state) 
                            => state.amount == 0 
                              ? Custom_Text(text: '0', color: Colors.white, fontWeight: FontWeight.bold )
                              : Custom_Text(text: '${state.products!.length}', color: Colors.white, fontWeight: FontWeight.bold )
                        )
                      ),
                    ),
                  ),
