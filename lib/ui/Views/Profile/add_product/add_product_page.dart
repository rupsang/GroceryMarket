      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Custom_Text(
              ...
              fontSize: 30,
              fontWeight: FontWeight.w900, color: kSecondaryColor,),
          elevation: 0,
          centerTitle: true,
          leading: IconButton(
            splashRadius: 20,
          ...
          child: ListView(
            ...
            children: [
              ...
              TextForm(
                ...
                hintText: 'Product ID',
                validator:
                    RequiredValidator(errorText: 'Product id is required'),
              ),
              ...
              //       ? Custom_Text(text: state.nameCategory!, color: Colors.black54)
              //       : Custom_Text(text: 'Select Category', color: Colors.black54)
              //     )
              //   ),
              // ),
            ],
