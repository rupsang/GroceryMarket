    ...
    return BlocListener<UserBloc, UserState>(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Colors.white,
          elevation: 0,
          title: const Custom_Text(text: 'My Profile', color: Colors.black, fontWeight: FontWeight.w500),
          centerTitle: true,
          leading: IconButton(
            splashRadius: 20,
          ...
          actions: [
            TextButton(
              ...
              child: const Custom_Text(text: 'Save', color: ColorsCustom.kprimaryColor, fontSize: 18,)
            )
          ],
        ),
        body: Form(
          ...
          child: ListView(
            ...
            children: [
              ...
              const Custom_Text(text: 'Account data', fontSize: 18),
                    ...
                    child: Column(
                      children: [
                        Row(
                          ...
                          children: [
                            const Custom_Text(text: 'User', fontSize: 18, fontWeight: FontWeight.w500),
                            Custom_Text(text: state.user!.users, fontSize: 18),
                          ],
                        ),
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            const Custom_Text(text: 'Email', fontSize: 18, fontWeight: FontWeight.w500),
                            Custom_Text(text: state.user!.email, fontSize: 18),
                          ],
                        ),
                      ],
                    ),
              ...
              const Custom_Text(text: 'Personal Information', fontSize: 18),
              const SizedBox(height: 10.0),
              TextForm(
