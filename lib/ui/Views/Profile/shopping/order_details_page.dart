              ...
              => Padding(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Flexible(
                        child: Custom_Text(text: orderDetails[i].nameProduct.toUpperCase(), fontSize: 19, overflow: TextOverflow.ellipsis,  fontWeight: FontWeight.w500 )
                      ),
                      ...
                      Row(
                        children: [
                          ...
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Custom_Text(text: 'Price: \$ ${orderDetails[i].price}', fontSize: 20, ),
                              const SizedBox(height: 5.0),
                              Custom_Text(text: 'Quantity: ${orderDetails[i].quantity}', fontSize: 20),                              
                            ],
                          )
                        ],
                      ),
