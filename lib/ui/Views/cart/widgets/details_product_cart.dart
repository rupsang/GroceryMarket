                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Flexible(
                            child: Custom_Text(text: state.products![i].name, fontSize: 19, overflow: TextOverflow.ellipsis )
                          ),
                          GestureDetector(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Custom_Text(text: '\$ ${state.products![i].price}', fontSize: 20, fontWeight: FontWeight.w600 ),
                                  ...
                                  children: [
                                    GestureDetector(
                                      child: Container(
                                        ...
                                        child: const Icon(Icons.remove, color: ColorsCustom.kprimaryColor ),
                                      ),
                                      onTap: (){
                                    ...
                                    Container(
                                      ...
                                      width: 35,
                                      color: Colors.white,
                                      child: Center(child: Custom_Text(text: '${state.products![i].amount}', fontSize: 18)),
                                    ),
                                    GestureDetector(
                                      onTap: () {
                                      ...
                                      child: Container(
                                        ...
                                        child: const Icon(Icons.add, color: ColorsCustom.kprimaryColor ),
                                      ),
                                    ),
                                  ],
                                ),
