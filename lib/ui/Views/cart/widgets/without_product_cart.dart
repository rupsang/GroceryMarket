        ...
        ? state.products!.length != 0 
          ? SizedBox(
              ...
              child: Column(
                ...
                children: [
                Icon(Icons.shopping_bag_outlined, size: 90, color: ColorsCustom.kprimaryColor.withOpacity(.7)),
                const SizedBox(height: 20),
                const Custom_Text(text: 'There is a cart to fill!', fontSize: 20, fontWeight: FontWeight.bold),
                const SizedBox(height: 20),
                const Custom_Text(text: 'Currently do not have ', fontSize: 16),
                const SizedBox(height: 5),
                const Custom_Text(text: 'any products in your shopping cart', fontSize: 16),
                ...
                Padding(
                  ...
                  child: TextButton(
                    ...
                    child: const Custom_Text(text: 'Go Products', fontSize: 19 ),
