  ...
  Widget build(BuildContext context){
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Custom_Text(text: 'Categories', color: Colors.black87, fontWeight: FontWeight.w500, fontSize: 20),
        centerTitle: true,
      ),
      ...
      itemBuilder: (context, i) => GestureDetector(
        child: Container(
          ...
          decoration: BoxDecoration(
            color: ColorsCustom.kprimaryColor.withOpacity(.2),
          ...
          child: Column(
            ...
            children: [
              SvgPicture.network(URLS.baseUrl+ categories[i].picture, height: 85, color: ColorsCustom.kprimaryColor),
              const SizedBox(height: 10.0),
              Custom_Text(text: categories[i].category, fontSize: 20, overflow: TextOverflow.ellipsis )
            ],
          ),
        ),
