  ...
  Widget build(BuildContext context){
    ...
    return BlocListener<ProductBloc, ProductState>(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Custom_Text(text: widget.category, color: Colors.black, fontWeight: FontWeight.w500, fontSize: 20),
          centerTitle: true,
          elevation: 0,
                          ...
                          Column(
                            ...
                            children: [
                              Container(
                                ...
                                Custom_Text(text: snapshot.data![i].nameProduct, fontWeight: FontWeight.w500 ),
                                Custom_Text(text: '\$ ${snapshot.data![i].price}', fontSize: 16 ),
                            ],
                          ),
                          Positioned(
                            right: 0,
