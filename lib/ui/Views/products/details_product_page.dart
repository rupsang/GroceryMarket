              ...
              ListView(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Wrap(
                      children: [
                        Custom_Text(text: widget.product.nameProduct, fontSize: 25, fontWeight: FontWeight.bold )
                      ],
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: const Custom_Text(text: 'Shipping normally', fontSize: 18, color: Colors.white ),
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      child: Row(
                        children: const [
                          Custom_Text(text: 'Available. ', fontSize: 18, color: Colors.green ),
                          Custom_Text(text: 'In Stock', fontSize: 18, ),
                        ],
                      ),
                    ),
                  ), 
                  ...
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: 20.0),
                    child: const Custom_Text(text: 'Description', fontSize: 20, fontWeight: FontWeight.bold ),
                  ),
                  ...
                  Padding(
                    ...
                    child: Wrap(
                      children: [
                        Custom_Text(text: widget.product.description, fontSize: 17)
                      ],
                    ),
                  ),
                  ...
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: 20.0),
                    child: const Custom_Text(text: 'Payment methods', fontSize: 20, fontWeight: FontWeight.bold ),
                  ),
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Image.asset('assets/credit-card.svg', height: 60, color: ColorsCustom.bgcolor,),
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        ...
                        height: 55,
                        width: size.width * .45,
                        child: Custom_Text(text: '\$ ${widget.product.price}', fontSize: 22, fontWeight: FontWeight.bold),
                      ),
                      // SizedBox(width: 15.0),
                      Container(
                        height: 55,
                        ...
                        child: TextButton(
                          ...
                          child: const Custom_Text(text: 'Add to cart', fontSize: 20, color: Colors.white, fontWeight: FontWeight.w500 ),
                          onPressed: (){
